      ...
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <main className="space-y-10 text-slate-300 leading-relaxed">
          <section className="space-y-4">
            <h2 className="text-xl font-black text-white uppercase tracking-wider border-b border-white/5 pb-2">{t('privacy.section1.title')}</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-black text-white uppercase tracking-wider border-b border-white/5 pb-2">{t('privacy.section2.title')}</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-black text-white uppercase tracking-wider border-b border-white/5 pb-2">{t('privacy.section3.title')}</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-black text-white uppercase tracking-wider border-b border-white/5 pb-2">{t('privacy.section4.title')}</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-black text-white uppercase tracking-wider border-b border-white/5 pb-2">{t('privacy.section5.title')}</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-black text-white uppercase tracking-wider border-b border-white/5 pb-2">{t('privacy.section6.title')}</h2>
            <p>
