  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 pt-[55vh]">
        <div className="bg-slate-950/80 backdrop-blur-xl border-t border-white/5 rounded-t-[3rem] p-8 shadow-[0_-20px_40px_rgba(0,0,0,0.5)]">
              ...
              <div className="flex flex-wrap gap-2">
                {intereses.map((interes: string, idx: number) => (
                  <motion.span 
                    ...
                    className="px-4 py-2 rounded-xl bg-white/5 border border-white/5 text-[10px] font-bold text-slate-400 hover:bg-white/10 transition-colors cursor-default"
                  >
                    #{interes}
                  </motion.span>
                ))}
