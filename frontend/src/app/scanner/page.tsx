            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-xs text-white placeholder:text-slate-600 focus:outline-none focus:border-fuchsia-500/50"
                />
                <button
                  onClick={() => validateToken(manualToken)}
                  disabled={!manualToken || validating}
                  className="px-6 py-3 rounded-2xl bg-fuchsia-600 text-white text-[10px] font-black uppercase tracking-widest disabled:opacity-50"
                >
                  {validating ? '...' : 'Validar'}
                </button>
              </div>
          ...
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 p-6 rounded-3xl space-y-4">
              ...
              <input
                ...
                className="w-full bg-black/30 border border-white/10 rounded-2xl px-4 py-4 text-sm text-white placeholder:text-slate-600 focus:outline-none focus:border-fuchsia-500/50 font-mono"
              />
              <button
                onClick={() => validateToken(manualToken)}
                disabled={!manualToken || validating}
                className="w-full py-4 rounded-2xl bg-fuchsia-600 text-white text-xs font-black uppercase tracking-[0.2em] disabled:opacity-50 transition-all active:scale-95"
              >
        ...
        <AnimatePresence>
          {result && (
            ...
            >
              ...
              <button
                onClick={handleReset}
                className="w-full py-4 rounded-2xl bg-white/10 text-white font-black uppercase tracking-[0.2em] text-xs hover:bg-white/20 transition-all"
              >
