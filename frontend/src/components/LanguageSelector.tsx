...
export default function LanguageSelector() {
  ...
  return (
    <div className="fixed top-20 right-4 z-[999]" ref={dropdownRef}>
      <button 
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full right-0 mt-2 bg-slate-900 border border-white/10 rounded-xl overflow-hidden shadow-2xl flex flex-col w-24"
          >
            {languages.map((lang) => (
              <button
                key={lang.code}
