  ...
  return (
    <div className="fixed top-4 right-4 z-[999999] pointer-events-auto" ref={dropdownRef}>
      <button 
        ...
        className="flex items-center justify-center gap-2 bg-slate-900/95 text-white backdrop-blur-2xl border border-fuchsia-500/50 px-3.5 py-2 rounded-full text-xs font-black uppercase tracking-wider hover:bg-slate-800 transition-all shadow-[0_10px_25px_rgba(0,0,0,0.8)] active:scale-95"
      >
        ...
        <span className="text-[9px] text-fuchsia-400 ml-0.5">▼</span>
      </button>
