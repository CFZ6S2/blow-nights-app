...
export default function NotificationToast() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="bg-slate-900/90 backdrop-blur-3xl border border-white/10 p-4 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center gap-4">
          ...
          <div className="flex-1 overflow-hidden">
            <h4 className="text-xs font-black uppercase tracking-widest text-fuchsia-400 truncate">
              {notification.title}
            </h4>
