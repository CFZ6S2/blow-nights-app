  ...
  return (
    <div className={`relative overflow-hidden ${className}`}>
      ...
      {shouldBlur && (
        ...
        >
          <span className="material-icons text-slate-900/80 text-2xl">visibility_off</span>
          <span className="text-[9px] text-slate-900/70 font-black uppercase tracking-widest mt-1">{t('nsfw.tap_to_view')}</span>
        </button>
      )}
    </div>
  );
