...
export default function ViewerToast() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="bg-white/80 backdrop-blur-2xl border border-slate-700/30 px-5 py-3 rounded-2xl shadow-[0_10px_40px_rgba(217,70,239,0.2)] flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-800">{t('viewer_toast.live_activity')}</p>
