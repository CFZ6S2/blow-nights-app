  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        {Object.keys(pricing).length === 0 ? (
          <div className="text-center py-10 space-y-3">
            <span className="material-icons text-5xl text-slate-900/10">production_quantity_limits</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <AnimatePresence>
              {Object.entries(pricing).map(([key, item]: [string, any]) => (
                ...
                >
                  <div>
                    <h4 className="text-sm font-black text-slate-900 capitalize">{item.name || key}</h4>
                    <p className="text-[10px] text-slate-500 mt-1 line-clamp-1">{item.description || 'Sin descripción'}</p>
                    
                    <div className="flex items-center gap-3 mt-3">
                      <span className="text-xs font-black text-slate-800 bg-fuchsia-500/10 px-2 py-1 rounded-lg border border-slate-700/20">
                  ...
                  <button 
                    ...
                    className="w-10 h-10 rounded-full bg-red-500/10 text-red-400 flex items-center justify-center hover:bg-red-500 hover:text-slate-900 transition-colors border border-red-500/20 opacity-0 group-hover:opacity-100"
                  >
      ...
      <motion.div 
        ...
        className="bg-gradient-to-br from-fuchsia-900/20 to-indigo-900/20 backdrop-blur-xl border border-slate-700/20 p-6 md:p-8 rounded-[2rem] shadow-2xl space-y-6"
      >
        <div className="flex items-center gap-3 border-b border-white/10 pb-4">
          <div className="w-10 h-10 rounded-2xl bg-white/10 flex items-center justify-center">
            <span className="material-icons text-slate-900">add_circle_outline</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="col-span-1">
            ...
            <input
              ...
              className="w-full bg-black/40 border border-slate-700/20 rounded-2xl px-4 py-4 text-sm text-slate-900 focus:outline-none focus:border-fuchsia-400 focus:ring-1 focus:ring-fuchsia-400 transition-all placeholder:text-slate-900/20"
            />
          </div>
          <div className="col-span-1">
          ...
          <div className="col-span-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black/40 border border-slate-700/20 rounded-2xl pl-11 pr-4 py-4 text-sm text-slate-900 focus:outline-none focus:border-fuchsia-400 focus:ring-1 focus:ring-fuchsia-400 transition-all placeholder:text-slate-900/20"
              />
            </div>
          </div>
          <div className="col-span-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black/40 border border-slate-700/20 rounded-2xl pl-11 pr-4 py-4 text-sm text-slate-900 focus:outline-none focus:border-fuchsia-400 focus:ring-1 focus:ring-fuchsia-400 transition-all font-mono text-xs placeholder:text-slate-900/20"
              />
            </div>
          </div>
          <div className="col-span-1 md:col-span-2">
