        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              >
                <span
                  className={`material-icons text-2xl block transition-colors duration-300 ${
                    active ? "text-slate-800 drop-shadow-[0_0_8px_rgba(192,38,211,0.5)]" : "text-slate-500"
                  }`}
                >
                  {item.icon}
                </span>
              ...
              <span className={`text-[10px] font-black uppercase tracking-tighter transition-colors duration-300 ${active ? "text-slate-800" : "text-slate-500"}`}>
                {item.label}
              </span>
            </Link>
          );
