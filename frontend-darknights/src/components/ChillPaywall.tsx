  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gradient-to-b from-slate-900 to-black border border-slate-300 w-full max-w-md rounded-t-3xl sm:rounded-3xl p-6 pb-10 relative overflow-hidden"
      >
        {/* Glow effect */}
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full mb-4">
            <span className="material-icons text-slate-900/70 text-sm">nightlife</span>
            <span className="text-[10px] font-black text-slate-900 uppercase tracking-widest">{t('paywall.exclusive_black')}</span>
          </div>
