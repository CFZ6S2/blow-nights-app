      ...
      <header className="py-6 px-4 flex justify-between items-center">
        ...
        {isSuperAdmin ? (
          <Link href={cityPath('/profile')} className="p-2 hover:bg-white/10 rounded-full transition-all">
            <span className="material-icons text-2xl text-slate-500">person</span>
          </Link>
        ) : (
          <div className="w-10" />
        )}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-baseline">
                  <h3 className="font-bold text-slate-900 group-hover:text-purple-400 transition-colors">{chat.otherUser?.nick}</h3>
