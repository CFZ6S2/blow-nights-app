        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-3xl p-8 hover:border-slate-300 transition-all">
              ...
              <p className="text-slate-500 text-sm mt-2 mb-6">{t('business.planRadarDesc')}</p>
              <div className="mb-8">
              ...
              <Link href="/business/login" className="block w-full py-4 text-center rounded-2xl bg-white/5 hover:bg-white/10 text-slate-900 font-bold transition-all">
                {t('business.startRadarBtn')}
              </Link>
            </div>

            {/* Plan PRO */}
            <div className="relative bg-gradient-to-b from-fuchsia-900/40 to-slate-950 border-2 border-slate-700/50 rounded-3xl p-8 shadow-2xl shadow-fuchsia-900/20 transform md:-translate-y-4">
              <div className="absolute top-0 inset-x-0 flex justify-center -translate-y-1/2">
                <span className="bg-gradient-to-r from-slate-800 to-indigo-600 text-slate-900 text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full">
                  {t('business.mostPopular')}
                </span>
              </div>
              <h3 className="text-2xl font-black text-slate-900">{t('business.planProTitle')}</h3>
              ...
              <Link href="/business/login" className="block w-full py-4 text-center rounded-2xl bg-gradient-to-r from-slate-800 to-indigo-600 hover:from-fuchsia-500 hover:to-indigo-500 text-slate-900 font-bold transition-all shadow-lg shadow-fuchsia-500/25">
