...
export default function BusinessLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-fuchsia-500/30">
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-50/80 backdrop-blur-xl border-b border-white/10">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              className="space-y-8"
            >
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-fuchsia-500/10 border border-slate-700/20 text-slate-800 text-xs font-bold uppercase tracking-wider">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link
                  href="/business/login"
                  className="px-8 py-4 bg-gradient-to-r from-slate-800 to-indigo-600 hover:from-fuchsia-500 hover:to-indigo-500 text-slate-900 text-sm font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-fuchsia-500/20 transition-all flex items-center justify-center gap-2"
                >
                  {t('business.enterPanel')} <ArrowRight className="w-4 h-4" />
                </Link>
                <button className="px-8 py-4 bg-white/5 hover:bg-white/10 text-slate-900 text-sm font-black uppercase tracking-widest border border-white/10 rounded-2xl transition-all flex items-center justify-center">
            ...
            <motion.div 
              ...
              className="relative"
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-slate-800/20 to-indigo-600/20 blur-[100px] rounded-full" />
              <div className="relative bg-white border border-white/10 rounded-3xl p-8 shadow-2xl overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-8">
                  <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">{t('business.updatedAgo')}</p>
                  </div>
                ...
                <div className="space-y-4">
                  {[
                    { label: t('business.ticketsSold'), value: '342 / 500', icon: QrCode, color: 'text-slate-800' },
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-slate-500 text-lg">
              {t('business.dynamicQrTech1')} <span className="text-slate-900 font-bold">{t('business.dynamicQr')}</span> {t('business.dynamicQrTech2')}
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Bad Way */}
            <div className="bg-white/50 border border-slate-200 rounded-3xl p-8 relative overflow-hidden group">
      ...
      <section className="py-24 bg-white border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-slate-500">{t('business.plansDescription')}</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-3xl p-8 hover:border-slate-700 transition-all flex flex-col justify-between">
              <div>
                <h3 className="text-2xl font-black text-white">{t('business.planBásicoTitle', 'Básico')}</h3>
            ...
            {/* Plan Promo */}
            <div className="bg-slate-950 border border-red-500/40 rounded-3xl p-8 hover:border-red-500/80 transition-all flex flex-col justify-between relative shadow-xl">
              <div>
                <h3 className="text-2xl font-black text-red-400">{t('business.planPromoTitle', 'Promo / Destacado')}</h3>
              ...
              <Link href="/business/login" className="block w-full py-4 text-center rounded-2xl bg-red-600 hover:bg-red-500 text-white font-bold transition-all shadow-lg shadow-red-500/20">
                {t('business.startPromoBtn', 'Elegir Promo')}
              </Link>
            </div>

            {/* Plan Ticketing */}
            <div className="relative bg-gradient-to-b from-red-950/40 to-slate-950 border-2 border-red-500/50 rounded-3xl p-8 shadow-2xl shadow-red-900/20 flex flex-col justify-between transform md:-translate-y-2">
              <div className="absolute top-0 inset-x-0 flex justify-center -translate-y-1/2">
                <span className="bg-gradient-to-r from-red-600 to-amber-600 text-white text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full shadow-lg">
              ...
              <div>
                ...
                <p className="text-red-200/60 text-sm mt-2 mb-6">{t('business.planTicketingDesc', 'Venta directa de entradas, Stripe Express y gestión de RRPPs.')}</p>
                <div className="mb-8">
                  <span className="text-4xl font-black text-white">100€</span>
                  <span className="text-red-200/50 font-medium">/mes</span>
                </div>
                <ul className="space-y-4 mb-8">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-sm text-red-100/80 font-medium">
                      <CheckCircle2 className="w-5 h-5 text-red-400 shrink-0" />
                      {feature}
                    </li>
                  ))}
              ...
              <Link href="/business/login" className="block w-full py-4 text-center rounded-2xl bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-500 hover:to-amber-500 text-white font-bold transition-all shadow-lg shadow-red-500/25">
      ...
      >
        ...
        <span className="absolute right-full mr-4 bg-white text-slate-900 text-sm px-4 py-2 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none border border-slate-300 shadow-xl">
