...
export default function BusinessLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 selection:bg-fuchsia-500/30">
      <motion.div 
      ...
      >
        <div className="flex justify-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-slate-800 to-indigo-600 rounded-2xl flex items-center justify-center shadow-xl shadow-fuchsia-500/20">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4 mb-6">
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1">{t('business.login.form.email_label')}</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-xl pl-11 pr-4 py-3 focus:outline-none focus:border-slate-700 focus:ring-1 focus:ring-fuchsia-500 transition-all"
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1">{t('business.login.form.password_label')}</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-4 py-4 bg-gradient-to-r from-slate-800 to-indigo-600 hover:from-fuchsia-500 hover:to-indigo-500 text-slate-900 text-sm font-black uppercase tracking-widest rounded-xl shadow-lg shadow-fuchsia-500/20 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
            >
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            <span className="relative bg-white px-4 text-xs text-slate-500 font-bold uppercase">{t('business.login.or_continue_with')}</span>
          </div>
