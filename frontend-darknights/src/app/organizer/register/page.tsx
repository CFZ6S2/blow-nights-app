...
export default function OrganizerRegisterPage() {
  ...
  const pendingView = (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white border border-slate-700/30 rounded-3xl p-8 shadow-2xl text-center">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white border border-slate-200 rounded-3xl p-8 shadow-2xl">
            ...
            {!user ? (
              <button
                ...
                className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-slate-900 font-bold uppercase tracking-widest text-sm py-4 rounded-xl hover:from-indigo-500 hover:to-purple-500 transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(79,70,229,0.4)]"
              >
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-slate-500">{t('organizer_register.base_city')}</label>
                  <input
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-slate-500">{t('organizer_register.phone')}</label>
                  <input
                    type="tel"
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-slate-900 font-bold uppercase tracking-widest text-sm py-4 rounded-xl hover:from-indigo-500 transition-all mt-4 disabled:opacity-50"
                >
