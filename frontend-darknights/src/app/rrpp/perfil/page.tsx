    ...
    <div className="min-h-screen bg-black text-slate-900 p-6 pb-24 font-sans">
      <div className="max-w-md mx-auto pt-8">
        <header className="mb-8">
          ...
          <p className="text-sm text-slate-500">{t('rrppProfile.accountDesc')}</p>
        </header>

        <div className="bg-white border border-slate-200 rounded-3xl p-6 space-y-6">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-slate-900 rounded-2xl flex items-center justify-center text-2xl font-black shadow-lg shadow-fuchsia-600/20">
