...
export default function OrganizerRegisterPage() {
  ...
  const pendingView = (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-slate-900 border border-amber-500/30 rounded-3xl p-8 shadow-2xl text-center">
      ...
      <div className="max-w-2xl mx-auto pt-12">
        ...
        {(submitted || alreadyPending) ? pendingView : (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 mb-8 text-sm text-slate-300">
            ...
            {!user ? (
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold uppercase tracking-widest text-sm py-4 rounded-xl hover:from-blue-500 hover:to-blue-600 transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(37,99,235,0.4)]"
              >
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-100 border border-slate-200 rounded-xl px-4 py-4 text-sm focus:border-blue-500 outline-none transition-colors"
                  />
                </div>
                <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold uppercase tracking-widest text-sm py-4 rounded-xl hover:from-blue-500 transition-all mt-4 disabled:opacity-50"
                >
