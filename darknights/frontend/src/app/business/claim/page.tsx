  ...
  return (
    <div className="min-h-screen bg-[#07080d] text-white flex flex-col justify-center items-center p-6 selection:bg-amber-500/30">
      <motion.div 
        ...
        className="w-full max-w-md bg-slate-900 border border-slate-200 p-8 rounded-3xl relative overflow-hidden shadow-2xl"
      >
        ...
        <form onSubmit={handleClaim} className="space-y-4">
          <div>
            ...
            <input required placeholder={t('business.claim.form.name_placeholder')} className="w-full bg-black border border-slate-200 rounded-xl px-4 py-3 text-sm focus:border-amber-500 outline-none" />
          </div>
          ...
          <div>
            ...
            <input required type="tel" placeholder="+34 600 000 000" className="w-full bg-black border border-slate-200 rounded-xl px-4 py-3 text-sm focus:border-amber-500 outline-none" />
          </div>
