...
export default function BusinessLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 selection:bg-amber-500/30">
      <motion.div 
      ...
      >
        <div className="flex justify-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-slate-800 to-blue-900 rounded-2xl flex items-center justify-center shadow-xl shadow-amber-500/20">
            <Building2 className="w-8 h-8 text-white" />
          </div>
        </div>
        
        <div className="text-center mb-8 space-y-2">
          <h1 className="text-3xl font-black text-white">BlowNights <span className="text-amber-400">Business</span></h1>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4 mb-6">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-800 text-white text-sm rounded-xl pl-11 pr-4 py-3 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-4 py-4 bg-gradient-to-r from-slate-800 to-blue-900 hover:from-slate-700 hover:to-blue-800 text-white text-sm font-black uppercase tracking-widest rounded-xl shadow-lg shadow-amber-500/20 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
            >
