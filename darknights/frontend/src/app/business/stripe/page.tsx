  ...
  return (
    <div className="min-h-screen bg-[#0b0c10] text-white p-6">
      <header className="mb-10 text-center pt-8">
        <h1 className="text-3xl font-black mb-2 uppercase tracking-widest text-amber-400">{t('business.stripe.title')}</h1>
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <div className="flex gap-4 items-start">
                    <span className="bg-amber-500/20 text-amber-400 p-2 rounded-lg">1</span>
                    <p className="text-sm text-slate-300">{t('business.stripe.step_1')}</p>
                  </div>
                  <div className="flex gap-4 items-start">
                    <span className="bg-amber-500/20 text-amber-400 p-2 rounded-lg">2</span>
                    <p className="text-sm text-slate-300">{t('business.stripe.step_2')}</p>
                  </div>
                  <div className="flex gap-4 items-start">
                    <span className="bg-amber-500/20 text-amber-400 p-2 rounded-lg">3</span>
