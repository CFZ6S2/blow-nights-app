...
function BuyTicketContent() {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 flex flex-col items-center justify-center">
      <div className="bg-slate-900/80 border border-slate-200 p-8 rounded-3xl w-full max-w-md shadow-2xl relative overflow-hidden">
        <div className="absolute top-0 right-0 bg-amber-600 text-white text-[10px] font-black px-4 py-1 rounded-bl-2xl uppercase tracking-widest">
          {t('buy.secure_purchase')}
        </div>

        <h1 className="text-2xl font-black mb-1 mt-4 text-amber-400 uppercase tracking-widest">
        ...
        <div className="bg-slate-50 rounded-2xl p-4 mb-6 border border-slate-200">
          ...
          <div className="border-t border-slate-200 pt-2 mt-2 flex justify-between">
            ...
            <span className="font-black text-amber-400 text-xl">{totalPrice.toFixed(2)} €</span>
          </div>
        </div>
