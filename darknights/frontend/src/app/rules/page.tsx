...
export default function RulesPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 p-8 md:p-20 selection:bg-amber-500/30">
      <header className="max-w-4xl mx-auto flex justify-between items-center mb-20">
        ...
        <h1 className="text-xl font-black uppercase tracking-[0.3em] bg-clip-text text-transparent bg-gradient-to-r from-slate-700 to-blue-800">
          {t('rules.title')}
        </h1>
      ...
      <main className="max-w-4xl mx-auto space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <motion.div 
              ...
              className="p-10 rounded-[3rem] bg-slate-50 border border-slate-200 space-y-8 relative overflow-hidden group"
            >
        ...
        <section className="bg-gradient-to-br from-amber-600/20 to-blue-600/20 p-12 rounded-[3.5rem] border border-slate-200 text-center space-y-8">
