...
export default function PartnerApplicationPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 selection:bg-blue-500/30 font-sans p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-1">
                ...
                <select 
                  ...
                  className="w-full bg-white border border-slate-800 text-white text-sm rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-all appearance-none"
                >
              ...
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full bg-white border border-slate-800 text-white text-sm rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea 
                  ...
                  rows={4}
                  className="w-full bg-white border border-slate-800 text-white text-sm rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors resize-none"
                />
              </div>
              ...
              <div className="pt-4">
                <button 
                  ...
                  type="submit" 
                  className="w-full bg-gradient-to-r from-blue-700 to-blue-900 text-white font-bold uppercase tracking-widest text-sm py-4 rounded-xl hover:from-blue-600 hover:to-blue-800 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(59,130,246,0.4)]"
                >
