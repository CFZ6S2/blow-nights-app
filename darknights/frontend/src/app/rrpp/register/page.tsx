      ...
      <div className="max-w-2xl mx-auto pt-12">
        ...
        {(submitted || alreadyPending) ? pendingView : (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
            <div className="w-16 h-16 bg-amber-600/20 rounded-full flex items-center justify-center mb-6">
            ...
            {!user ? (
              <button
                ...
                className="w-full bg-gradient-to-r from-amber-500 to-red-600 text-white font-bold uppercase tracking-widest text-sm py-4 rounded-xl hover:from-amber-400 hover:to-red-500 transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(245,158,11,0.4)]"
              >
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-100 border border-slate-200 rounded-xl px-4 py-4 text-sm focus:border-amber-500 outline-none transition-colors"
                  />
                </div>
                <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-amber-500 to-red-600 text-white font-bold uppercase tracking-widest text-sm py-4 rounded-xl hover:from-amber-400 transition-all mt-4 disabled:opacity-50"
                >
