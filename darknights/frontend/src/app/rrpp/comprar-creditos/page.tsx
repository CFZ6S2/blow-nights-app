        ...
        <div className="space-y-4">
          ...
          >
            <div>
              ...
              <div className="text-3xl font-black text-amber-400 mb-6">25 €</div>
            </div>
            <button 
          ...
          <motion.div 
            whileTap={{ scale: 0.98 }}
            className="bg-slate-900 border border-amber-500/30 rounded-3xl p-6 relative overflow-hidden flex flex-col justify-between"
          >
            <div className="absolute top-0 right-0 bg-amber-600 text-white text-[10px] font-black px-3 py-1 rounded-bl-xl uppercase tracking-widest">
            ...
            <div>
              ...
              <div className="text-3xl font-black text-amber-400 mb-6">50 €</div>
            </div>
            <button 
              onClick={() => handleComprar(100)}
              disabled={loading}
              className="w-full bg-amber-600 hover:bg-amber-500 text-white font-black py-4 rounded-2xl uppercase tracking-widest text-sm transition-colors shadow-[0_0_30px_-10px_rgba(192,38,211,0.5)]"
            >
              {loading ? t('rrppBuyCredits.processing') : t('rrppBuyCredits.buyNow')}
            </button>
          </motion.div>
