    ...
    <div className="min-h-screen bg-black text-white p-6 pb-24 font-sans">
      <div className="max-w-md mx-auto pt-8">
        ...
        {promoterDocs.length === 0 && !showCreateForm && (
          <div className="bg-slate-900 border border-amber-500/30 rounded-3xl p-8 text-center mb-6">
            <h3 className="font-bold mb-3 text-amber-400 text-xl">{t('rrpp.noActiveEvents')}</h3>
            <p className="text-sm text-slate-300 mb-6 leading-relaxed">
              {t('rrpp.createFirstEvent')}
            </p>
            <div className="bg-slate-200 border border-slate-200 rounded-2xl p-5 text-xs text-slate-300 text-left mb-6">
              <p className="font-bold text-amber-400 mb-3 uppercase tracking-widest text-[10px]">{t('rrpp.howItWorks')}</p>
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <span className="bg-amber-500/20 text-amber-400 w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5">1</span>
                  <span>{t('rrpp.step1')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="bg-amber-500/20 text-amber-400 w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5">2</span>
                  <span>{t('rrpp.step2')}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="bg-amber-500/20 text-amber-400 w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5">3</span>
        ...
        {!showCreateForm ? (
          <button
            ...
            className="w-full py-5 bg-gradient-to-r from-amber-600 to-blue-600 hover:from-amber-500 hover:to-blue-500 rounded-2xl font-black text-sm uppercase tracking-widest shadow-[0_0_30px_-10px_rgba(192,38,211,0.5)] transition-all active:scale-[0.98] flex items-center justify-center gap-2"
          >
          ...
          <motion.div
            ...
            className="bg-slate-900 border border-amber-500/20 rounded-3xl p-6"
          >
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative border-2 border-dashed border-slate-700 hover:border-amber-500 rounded-2xl p-4 text-center cursor-pointer bg-slate-900/50">
                  <input 
                    type="file" 
                    accept="image/*" 
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-slate-200 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:border-amber-500 outline-none"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-slate-200 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:border-amber-500 outline-none appearance-none"
                >
