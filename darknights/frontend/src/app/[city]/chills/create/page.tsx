  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white pb-20 pt-8 px-4">
      <div className="max-w-md mx-auto">
        <h1 className="text-2xl font-bold mb-6 bg-gradient-to-r from-amber-500 to-amber-500 bg-clip-text text-transparent text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <div className={`p-3 rounded-full ${type === 'social' ? 'bg-amber-500 text-white shadow-[0_0_15px_rgba(217,70,239,0.5)]' : 'bg-gray-800 text-gray-400'}`}>
                <Users size={24} />
              </div>
              <div>
                <h3 className={`font-bold text-lg ${type === 'social' ? 'text-amber-400' : 'text-white'}`}>
          ...
          <div className="space-y-4 pt-2">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-900 border border-gray-800 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-amber-500 outline-none"
              />
            </div>
          ...
          <div className="bg-gray-900 border border-gray-800 p-4 rounded-xl mt-4">
            <label className="flex items-start gap-3 cursor-pointer">
              <input 
                ...
                className="mt-1 w-5 h-5 rounded border-gray-700 bg-gray-800 text-amber-500 focus:ring-amber-500/50"
              />
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold text-white shadow-xl transition-all mt-4 ${
              ...
              type === 'commercial' 
                ...
                : 'bg-gradient-to-r from-amber-600 to-blue-600 shadow-[0_0_20px_rgba(217,70,239,0.3)]'
            }`}
          >
