  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 p-6 md:p-12 pb-32">
      <header className="mb-8">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">{profile.nick || (profile as any).email || ''} · DARKNIGHTS Partner</p>
          </div>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <section className="bg-slate-50 border border-slate-200 p-6 rounded-2xl">
          ...
          <div className="space-y-3">
            ...
            {affiliatedCities.map(c => (
              <div key={c.id} className="bg-slate-100 border border-slate-200 p-4 rounded-xl flex justify-between items-center">
                <div>
        ...
        <section className="bg-slate-50 border border-slate-200 p-6 rounded-2xl h-[60vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto space-y-2 no-scrollbar">
            ...
            {earnings.map(e => (
              <div key={e.id} className="flex justify-between items-center bg-slate-100 p-3 rounded-xl border border-slate-200">
                <div>
