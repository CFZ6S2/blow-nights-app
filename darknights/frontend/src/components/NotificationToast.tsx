...
export default function NotificationToast() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="bg-slate-900/90 backdrop-blur-3xl border border-slate-200 p-4 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500 to-blue-600 flex items-center justify-center shadow-lg">
          ...
          <div className="flex-1 overflow-hidden">
            <h4 className="text-xs font-black uppercase tracking-widest text-amber-400 truncate">
              {notification.title}
            </h4>
