...
export default function PartnersLanding() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white selection:bg-blue-500/30 font-sans">
      ...
      {/* HEADER NAVIGATION */}
      <header className="fixed top-0 w-full z-50 bg-neutral-950/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded bg-gradient-to-br from-blue-700 to-amber-500 flex items-center justify-center font-bold text-lg">B</div>
      ...
      <section className="pt-40 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <span className="inline-block py-1 px-3 rounded-full bg-blue-500/10 text-blue-400 font-medium text-sm mb-6 border border-blue-500/20">
          ...
          >
            El <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-amber-500">{t('operating_system')}</span><br />{t('lgtbiq_nightlife')}
          </motion.h1>
          ...
          >
            <Link href="mailto:partners@darknights.com" className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-blue-700 to-amber-500 text-white font-bold text-lg hover:shadow-[0_0_30px_-5px_rgba(59,130,246,0.5)] transition-all transform hover:scale-105">
              {t('contact_team')}
            </Link>
            <Link href="#motores" className="w-full sm:w-auto px-8 py-4 rounded-full bg-slate-50 text-white font-semibold text-lg border border-slate-200 hover:bg-slate-100 transition-colors">
      ...
      {hotCities.length > 0 && (
        <section className="py-12 bg-neutral-900 border-t border-b border-blue-500/20 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {hotCities.map(city => (
                <div key={city.id} className="bg-slate-200 border border-slate-200 rounded-2xl p-6 relative overflow-hidden group">
                  ...
                  <Link href={`mailto:partners@darknights.com?subject=Solicitud Franquicia ${city.slug}`} className="block w-full py-3 text-center bg-slate-50 hover:bg-blue-600 border border-slate-200 hover:border-blue-500 rounded-xl font-bold transition-all">
      ...
      {/* LOS 4 MOTORES */}
      <section id="motores" className="py-24 px-6 border-t border-slate-200 bg-neutral-950">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Motor 1 */}
            <div className="bg-neutral-900 border border-slate-200 p-8 rounded-3xl hover:border-blue-500/50 transition-colors group">
              ...
              <ul className="space-y-2 text-sm text-neutral-500">
                <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-blue-500 mr-2"></span>Split de pagos automatizado</li>
                <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-blue-500 mr-2"></span>Venta anticipada sin fricción</li>
              </ul>
            </div>
            
            {/* Motor 2 */}
            <div className="bg-neutral-900 border border-slate-200 p-8 rounded-3xl hover:border-amber-500/50 transition-colors group">
              ...
              <ul className="space-y-2 text-sm text-neutral-500">
                <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-amber-500 mr-2"></span>Enlaces /rrpp que se autodestruyen</li>
                <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-amber-500 mr-2"></span>Gestión ultra-rápida por WhatsApp</li>
              </ul>
            </div>
            ...
            {/* Motor 4 */}
            <div className="bg-neutral-900 border border-slate-200 p-8 rounded-3xl hover:border-green-500/50 transition-colors group">
      ...
      <section className="py-24 px-6 border-t border-slate-200 relative">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-blue-400 font-semibold tracking-wider uppercase text-sm mb-2 block">Revenue Split</span>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-200 text-neutral-400">
                  <th className="py-4 px-6 font-medium">Canal de Ingreso</th>
                  <th className="py-4 px-6 font-medium">Tarifa PVP</th>
                  <th className="py-4 px-6 font-semibold text-white">Socio Local (Tú)</th>
              ...
              <tbody className="divide-y divide-white/5">
                ...
                <tr className="hover:bg-slate-50 transition-colors border-l-4 border-l-amber-500 bg-amber-500/5">
                ...
                <tr className="hover:bg-slate-50 transition-colors bg-white/[0.02]">
                  <td className="py-5 px-6 font-medium flex items-center">
                    Blow VIP Mensual 
                    <span className="ml-3 text-[10px] uppercase font-bold bg-blue-500/20 text-blue-400 py-1 px-2 rounded-full">Popular</span>
                  </td>
      ...
      <section className="py-24 px-6 border-t border-slate-200 bg-gradient-to-b from-neutral-950 to-neutral-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Inicial */}
            <div className="bg-neutral-900 border border-slate-200 p-8 rounded-3xl flex flex-col">
              <div className="mb-6">
            ...
            {/* Moderado */}
            <div className="bg-neutral-800 border-2 border-blue-500 p-8 rounded-3xl flex flex-col relative transform md:-translate-y-4 shadow-[0_0_40px_-10px_rgba(59,130,246,0.3)]">
              ...
              <div className="mb-6 mt-2">
                <h3 className="text-xl font-semibold text-white">Fase Moderada</h3>
                <p className="text-sm text-blue-300">2-3 locales / 1 sesión fuerte</p>
              </div>
              <div className="text-5xl font-bold mb-6 text-white">~35.100€ <span className="text-lg font-normal text-blue-300">/ año</span></div>
              
              <div className="space-y-4 mb-8 flex-grow text-sm">
                <div className="flex justify-between border-b border-slate-200 pb-2">
                  <span className="text-neutral-300">Tickets/mes</span>
                  <span className="font-semibold text-white">3.000 (20€/ud)</span>
                </div>
                <div className="flex justify-between border-b border-slate-200 pb-2">
                ...
                <div className="flex justify-between border-b border-slate-200 pb-2">
                  ...
                  <span className="font-semibold text-white">150 activos</span>
                </div>
                <div className="flex justify-between border-b border-slate-200 pb-2">
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto bg-neutral-900/50 backdrop-blur-xl border border-slate-200 p-8 md:p-12 rounded-[2.5rem] text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <div className="text-left bg-slate-200 p-4 rounded-2xl w-full md:w-auto border border-slate-200">
          ...
          <div className="mt-12 pt-12 border-t border-slate-200 text-left">
      ...
      {/* FOOTER */}
      <footer className="border-t border-slate-200 py-12 px-6 text-center text-neutral-500">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            <div className="w-6 h-6 rounded bg-gradient-to-br from-neutral-700 to-neutral-900 flex items-center justify-center font-bold text-xs text-white">B</div>
