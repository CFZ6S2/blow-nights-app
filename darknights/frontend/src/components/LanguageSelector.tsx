  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-[999]" ref={dropdownRef}>
      <button 
        ...
        className="flex items-center justify-center gap-1.5 bg-slate-200 backdrop-blur-md border border-slate-200 px-3 py-1.5 rounded-full text-xs font-bold hover:bg-slate-100 transition-colors shadow-lg"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-1/2 -translate-x-1/2 mt-2 bg-slate-900 border border-slate-200 rounded-xl overflow-hidden shadow-2xl w-48"
          >
