...
export default function LanguageSelector() {
  ...
  return (
    <div className="fixed top-3 left-1/2 -translate-x-1/2 z-[999999]" ref={dropdownRef}>
      <button
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-1/2 -translate-x-1/2 mt-2 bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.8)] w-52"
          >
